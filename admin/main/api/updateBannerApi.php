...
if(isset($_FILES['banner_image']) && $_FILES['banner_image']['error'] === UPLOAD_ERR_OK)
{
    ...
    if ($file_error === UPLOAD_ERR_OK) 
    {
        ...
        if (move_uploaded_file($file_tmp_name, $destination)) 
        {
            ...
            $sql="update banners set banner_name='{$banner_name}', banner_image='{$new_file_name}', banner_text='{$banner_text}', package_id={$banner_package} where banner_id={$banner_id} and is_deleted=0";
...
else
{
    ...
    $sql="update banners set banner_name='{$banner_name}', banner_text='{$banner_text}', package_id={$banner_package} where banner_id={$banner_id} and is_deleted=0";
