<?php include('header.php'); ?>
		...
		<div id="site-banner"
			style="background-image: url(assets/wp-content/uploads/2020/04/optimised-banner.jpg);">
					...
					<div class="col-sm-12 col-main-content tours-gallery">
						...
						<div class="tours-sorter clearfix">
							<ul id="filters">
								...
								<li><a href="#" data-filter=".australia">Australia</a>
								<li><a href="#" data-filter=".brazil">Brazil</a>
								<li><a href="#" data-filter=".italy">Italy</a>
								<li><a href="#" data-filter=".maldives">Maldives</a>
								<li><a href="#" data-filter=".singapore">Singapore</a>
								<li><a href="#" data-filter=".turkey">Turkey</a>
							</ul>
						</div>
						<div class="row" id="items-list">
							<div class="col-xs-12 col-sm-6 col-md-4 item united-arab-emirates ">
							...
							<div class="col-xs-12 col-sm-6 col-md-4 item united-kingdom ">
								<div class="gallery-item clearfix">
									<figure>
										<img width="720" height="560"
							...
							<div class="col-xs-12 col-sm-6 col-md-4 item australia ">
								<div class="gallery-item clearfix">
									<figure>
										<img width="720" height="560"
							...
							<div class="col-xs-12 col-sm-6 col-md-4 item brazil ">
								<div class="gallery-item clearfix">
									<figure>
										<img width="720" height="560"
							...
							<div class="col-xs-12 col-sm-6 col-md-4 item maldives ">
								<div class="gallery-item clearfix">
									<figure>
										<img width="720" height="560"
							...
							<div class="col-xs-12 col-sm-6 col-md-4 item turkey ">
								<div class="gallery-item clearfix">
									<figure>
										<img width="720" height="560"
							...
							<div class="col-xs-12 col-sm-6 col-md-4 item singapore ">
								<div class="gallery-item clearfix">
									<figure>
										<img width="720" height="560"
							...
							<div class="col-xs-12 col-sm-6 col-md-4 item italy ">
								<div class="gallery-item clearfix">
									<figure>
										<img width="720" height="560"
